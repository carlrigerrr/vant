                ...
                <div className="flex flex-col md:flex-row flex-wrap gap-3 md:gap-4 mb-4">
                    ...
                    <div className="flex flex-wrap gap-2 w-full md:w-auto">
                        <button
                            ...
                            className="px-3 py-2 bg-gray-200 rounded-md hover:bg-gray-300 transition-colors text-sm">
                            Clear All
                        </button>
                        <button
                            onClick={fetchAttendanceData}
                            className="px-3 py-2 bg-blue-50 text-blue-600 rounded-md hover:bg-blue-100 transition-colors flex items-center gap-1 text-sm"
                        >
                            <RefreshIcon className="w-4 h-4" /> Refresh
                        </button>
                        <button
                            onClick={exportToCSV}
                            className="px-3 py-2 bg-green-50 text-green-600 rounded-md hover:bg-green-100 transition-colors flex items-center gap-1 text-sm"
                        >
