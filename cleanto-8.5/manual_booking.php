...
?>
									...
									<!-- <label class="method_not_selected_error show_methods_after_service_selection" id="method_not_selected_error" style="display:none;"><?php echo $label_language_values['please_select_method']; ?></label> -->
								...
								<div class="ct-user-info-main ct-common-box existing_user_details hide_allsss">
									<div class="ct-list-header">
										...
										<div class="ct-logged-in-user client_logout">
											...
											<a href="javascript:void(0)" class="ct-link ml-10" id="ct_change_customer" title="Change Customer<?php /* echo $label_language_values['log_out'];*/?>">Change User<?php /*echo $label_language_values['log_out'];*/?></a>
										</div>
										<!--</div>-->
									</div>
...
if ($all_existing_users->num_rows > 0) {
...
?>
										...
										<form id="user_details_form" class="" method="post" role="form">
											<div class="ct-new-user-details remove_preferred_password_and_preferred_email">
												<div class="row ct-xs-12">
											...
											<div class="ct-peronal-details">
													...
													<div class="ct-md-6 ct-sm-6 ct-xs-12 ct-form-row remove_guest_user_preferred_email fancy_input_wrap" style="display:none;">
										    ...
										    <div id="ct_email_hi" class="ct-md-6 ct-sm-6 ct-xs-12 ct-form-row fancy_input_wrap" style="display:none;">

														<input type="text" name="ct_emailss" id="ct-emailss" class="add_show_error_class error fancy_input" />
															<span class="highlight"></span>
															<span class="bar"></span>
														<label for="ct-emailss" class="fancy_label"><?php echo $label_language_values['preferred_email']; ?></label>
												</div>
												<div class="row ct-xs-12">
...
if ($address_check[0] == 'on') {?>
    ...
    ?>
													...
													<?php
if ($zip_check[0] == 'on') {?>
													<div class="ct-md-4 ct-sm-4 ct-xs-12 ct-form-row fancy_input_wrap">

														<input type="text" name="app_zip_code" id="app-zip-code" class="add_show_error_class error fancy_input" />
															<span class="highlight"></span>
															<span class="bar"></span>
...
if (isset($_SESSION['ct_login_user_id'])) {
    ?>
                <div class="ct-discount-coupons ct-md-12 mb-20">
                  <div class="ct-form-rown">
                    <div class="ct-coupon-input ct-md-6 ct-sm-12 ct-xs-12 mt-10 mb-15 np fancy_input_wrap">
                      <input id="user_coupon_val" type="text" name="user_coupon_val"  class="ct-coupon-input-text hide_user_coupon_textbox fancy_input user_coupon_val" placeholder="Apply coupon" maxlength="22" onchange="myFunction()"/>
                      <span class="highlight"></span>
                      <span class="bar"></span>
                      <label for="ct-user-name" class="fancy_label"></label>
                      <a href="javascript:void(0);" class="ct-apply-user-coupon ct-link hide_user_coupon_textbox" name="apply-coupon" id="apply_user_coupon"><?php echo $label_language_values['apply']; ?></a>
                      <label class="ct-error ofh user_coupon_invalid_error"></label>
                      <!-- display coupon -->
                      <div class="ct-display-user-coupon-code">
                        <div class="ct-form-rown">
                          <div class="ct-column ct-md-7 ct-xs-12 ofh">
                              <label>Applied user coupon</label>
                          </div>
                          <div class="ct-coupon-value-main ct-md-5 ct-xs-12">
                            <span class="ct-coupon-value border-2" id="display_user_code"></span>
                            <img id="ct-remove-applied-coupon" src="<?php echo SITE_URL; ?>/assets/images/ct-close.png" class="user_reverse_coupon" title="Remove applied coupon"/>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        if (empty($_GET["refer_code"])) {
            ?>
                <div class="ct-discount-coupons ct-md-12 mb-20">
                  <div class="ct-form-rown">
                    <div class="ct-coupon-input ct-md-6 ct-sm-12 ct-xs-12 mt-10 mb-15 np fancy_input_wrap">
                      <input id="referral_val" type="text" name="referral_val" class="ct-coupon-input-text hide_referral_textbox fancy_input referral_val" placeholder="Have a referral code ?" maxlength="22"/>
                      <span class="highlight"></span>
                      <span class="bar"></span>
                      <label for="ct-user-name" class="fancy_label"></label>
            ...
            /*$refercode_val = $_GET["refer_code"]; */
            if (isset($_GET["refer_code"])) {
                ?>
                        <div class="ct-discount-coupons ct-md-12 mb-20">
                          <div class="ct-form-rown">
                            <div class="ct-coupon-input ct-md-6 ct-sm-12 ct-xs-12 mt-10 mb-15 np fancy_input_wrap">
                              <input id="referral_val" type="text" name="referral_val" class="ct-coupon-input-text hide_referral_textbox fancy_input referral_val" value="<?php echo $_GET["refer_code"]; ?>" placeholder="Have a referral code ?" maxlength="22"/>
                              <span class="highlight"></span>
                              <span class="bar"></span>
                              <label for="ct-user-name" class="fancy_label"></label>
                              <a href="javascript:void(0);" class="ct-apply-coupon ct-link hide_referral_textbox" name="apply-coupon" id="apply_referral"><?php echo $label_language_values['apply']; ?>
