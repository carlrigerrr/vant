...
if (isset($_POST['getservice_addons'])) {
    ...
    if ($res->num_rows > 0) {
        while ($arrs = mysqli_fetch_array($res)) {
            $i++;?>
         <li class="panel panel-default ct-clean-services-panel cta-addon-icons mysortlistaddons" id="addons_service_<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" data-id="<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" data-position="<?php echo $arrs['position']; ?>">
            <div class="panel-heading">
               <h4 class="panel-title">
                  <div class="cta-col7">
                     ...
                     <span class="ct-clean-service-title-name" id="addons_service_name<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" title="<?php echo $label_language_values['extra_service_title']; ?>"><?php echo $arrs['addon_service_name']; ?></span>
                  </div>
               ...
               <input class='myservices_addons_status' data-toggle="toggle" data-size="small" type='checkbox' data-id="<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" <?php if ($arrs['status'] == 'E') {
            ...
            if ($t > 0) {?>
                  ...
                  <a id="ct-delete-service-addon<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" data-toggle="popover"class="delete-clean-service-btn pull-right btn-circle btn-danger btn-sm" rel="popover" data-placement='left' title="<?php echo $label_language_values['delete_this_addon_service']; ?>"> <i class="fa fa-trash" title="<?php echo $label_language_values['delete_service']; ?>"></i></a>
                           <div id="popover-delete-service" style="display: none;">
                              ...
                              <table class="form-horizontal" cellspacing="0">
                                 <tbody>
                                    <tr>
                                       <td>
                                       <button data-serviceaddonid="<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" value="Delete" class="btn btn-danger btn-sm service-addons-delete-button" data-imagename="<?php echo $arrs['image']; ?>" type="submit"><?php echo $label_language_values['yes']; ?>
                                       </button>
                                       <button id="ct-close-popover-delete-service-addon" class="btn btn-default btn-sm" href="javascript:void(0)" data-serviceaddonid="<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>"><?php echo $label_language_values['cancel']; ?>
                                    </button>
                                 </td>
                                    </tr>
                                 </tbody>
                        ...
                        <div class="ct-show-hide pull-right">
                           <input type="checkbox" name="ct-show-hide" class="ct-show-hide-checkbox" id="sp<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>"><!--Added Serivce Id-->                                
                           <label class="ct-show-hide-label" for="sp<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>"></label>
                        </div>
                     </div>
                  </div>
               </h4>
            </div>
            <div id="details_sp<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" class="serviceaddon_detail panel-collapse collapse">
               <div class="panel-body">
                  <div class="ct-service-collapse-div col-sm-12 col-md-6 col-lg-6 col-xs-12">
                     <form id="myformedt_addons_<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" method="post" type="" class="slide-toggle">
                        <table class="ct-create-service-table">
                           <tbody>
                              <tr>
                                 <td><label for="ct-service-title"><?php echo $label_language_values['addon_title']; ?></label></td>
                                 <td>
                                    <div class="col-xs-12 np"><input type="text" class="form-control txtedtaddon_title<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" id="myedtaddon_title<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" name = "myedtaddon_titlename<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" value="<?php echo $arrs['addon_service_name']; ?>"/>                                        </div>
                                 </td>
                              </tr>
                              <tr>
                              <tr>
                                 <td><label for="ct-service-desc"> Addon Description</label></td>
                                 <td>
                                    <div class="col-xs-12 np">                    <textarea id="myedtaddon_title_desc" class="form-control myedtaddon_titlenamedesc<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" ><?php echo $arrs['addon_service_description']; ?></textarea>                    </div>
                                 </td>
                              </tr>
            ...
            $modulas = fmod($duration, 60);?>
                              <td>
                                 <div class="form-inline">
                                    <div class="input-group">                                   <span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>                                   <input placeholder="00" size="2" maxlength="2" type="text" class="form-control txtedtaddon_hours<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" id="addon_edit_hours<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" name = "myedtaddon_durationhours<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" value="<?php echo $intval; ?>" />                                                                       <span class="input-group-addon"><?php echo $label_language_values['hours']; ?></span>                                </div>
                                    <div class="input-group cta_mt_10">                                  <input placeholder="05" size="2" maxlength="2" type="text" class="form-control txtedtaddon_mints<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" id="addon_edit_mints<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" name = "myedtaddon_durationmints<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" value="<?php echo $modulas; ?>"/>                                   <span class="input-group-addon"><?php echo $label_language_values['minutes']; ?></span>                                 </div>
                                 </div>
                              </td>
                              </tr>
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <div class="ct-clean-service-addons-image-uploader">
                                                ...
                                                }?>                                            <img data-imagename="" id="pcaol<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>addonimage" src="<?php echo $imagepath; ?>" class="ct-clean-service-addons-image br-100" height="100" width="100">                                 <?php if (@$arrs['image'] == '') {?>                                 <label for="ct-upload-imagepcaol<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" class="ct-clean-service-addons-img-icon-label ser_addons<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>">                                                <i class="ct-camera-icon-common br-100 fa fa-camera"></i>                                                <i class="pull-left fa fa-plus-circle fa-2x"></i>                                            </label>                               <?php
                                                               }?>                                            <input data-us="pcaol<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" data-id="<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" class="hide ct-upload-images" type="file" name="" id="ct-upload-imagepcaol<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" />                                 <label for="ct-upload-imagepcaol<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" class="ct-clean-service-addons-img-icon-label addon_ser_cam cam_btn_addon<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>">                                                <i class="ct-camera-icon-common br-100 fa fa-camera"></i>                                                <i class="pull-left fa fa-plus-circle fa-2x"></i>                                            </label>                                <?php if (@$arrs['image'] !== '') {?>
                                                            <a data-pcaolid="<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" id="ct-remove-service-addons-imagepcaol<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" class="pull-left br-100 btn-danger bt-remove-service-addons-img btn-xs addons_del_btn addons_del_icon<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" rel="popover" data-placement='left' title="<?php echo $label_language_values['remove_image']; ?>"> <i class="fa fa-trash" title="<?php echo $label_language_values['remove_service_image']; ?>"></i></a>                                            <?php
                                                               }?>
                                                   <a data-pcaolid="<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" id="ct-remove-service-addons-imagepcaol<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" class="pull-left br-100 btn-danger bt-remove-service-addons-img btn-xs new_addons_del del_btn_addon<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" rel="popover" data-placement='left' title="<?php echo $label_language_values['remove_image']; ?>"> <i class="fa fa-trash" title="<?php echo $label_language_values['remove_service_image']; ?>"></i></a>
                                       <div id="popover-ct-remove-service-addons-imagepcaol<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" style="display: none;">
                                          <div class="arrow"></div>
                                          <table class="form-horizontal" cellspacing="0">
                                             <tbody>
                                                <tr>
                                                   <td>
                                                   <a href="javascript:void(0)" id="" value="Delete" class="btn btn-danger btn-sm delete_image_addons" data-pcaolid="<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" type="submit"><?php echo $label_language_values['yes']; ?></a>
                                                   <a href="javascript:void(0)" id="ct-close-popover-service-addon-image" class="btn btn-default btn-sm" href="javascript:void(0)" data-pcaolid="<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>"><?php echo $label_language_values['cancel']; ?></a>                                                        </td>
                                                </tr>
                                             </tbody>
                                          </table>
                                       </div>
                                    ...
                                    <div class="cta-addons-imagelist-dropdown fl">
                                       <div class="cta-addons-selection-main">
                                          <div class="cta-addon-is update_id" data-id="<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" title="<?php echo $label_language_values['choose_your_addon_image']; ?>">
                                             <?php if ($arrs['predefine_image'] != "") {?>
                                             <div class="cta-addons-list" id="addonid_<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" data-name="<?php echo $arrs['predefine_image']; ?>" data-p_i_name="<?php echo $arrs['predefine_image_title']; ?>">
                                             ...
                                             <?php
                                                                                          ...
                                                                                          <div class="cta-addons-list" id="addonid_<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" data-name="" data-p_i_name="">
                                                                                       ...
                                                                                       <div class="cta-addons-dropdown display_update_<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" >
                                                                                          <div class="cta-addons-list select_addons" data-id="<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" data-name="ct-icon-fridge.png" data-p_i_name="<?php echo $label_language_values['inside_fridge']; ?>">
                                                                                          ...
                                                                                          <div class="cta-addons-list select_addons"  data-id="<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" data-name="ct-icon-oven.png" data-p_i_name="<?php echo $label_language_values['inside_oven']; ?>">
                                                                                          ...
                                                                                          <div class="cta-addons-list select_addons" data-id="<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" data-name="ct-icon-inside-window.png" data-p_i_name="<?php echo $label_language_values['inside_windows']; ?>">
                                                                                          ...
                                                                                          <div class="cta-addons-list select_addons" data-id="<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" data-name="ct-icon-carpet.png" data-p_i_name="<?php echo $label_language_values['carpet_cleaning']; ?>">
                                                                                          ...
                                                                                          <div class="cta-addons-list select_addons" data-id="<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" data-name="ct-icon-green-cleaning.png" data-p_i_name="<?php echo $label_language_values['green_cleaning']; ?>">
                                                                                          ...
                                                                                          <div class="cta-addons-list select_addons" data-id="<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" data-name="ct-icon-pets.png" data-p_i_name="<?php echo $label_language_values['pets_care']; ?>">
                                                                                          ...
                                                                                          <div class="cta-addons-list select_addons" data-id="<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" data-name="ct-icon-tiles.png" data-p_i_name="<?php echo $label_language_values['tiles_cleaning']; ?>">
                                                                                          ...
                                                                                          <div class="cta-addons-list select_addons" data-id="<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" data-name="ct-icon-wall-cleaning.png" data-p_i_name="<?php echo $label_language_values['wall_cleaning']; ?>">
                                                                                          ...
                                                                                          <div class="cta-addons-list select_addons" data-id="<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" data-name="ct-icon-laundry.png" data-p_i_name="<?php echo $label_language_values['laundry']; ?>">
                                                                                          ...
                                                                                          <div class="cta-addons-list select_addons" data-id="<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" data-name="ct-icon-basement.png" data-p_i_name="<?php echo $label_language_values['basement_cleaning']; ?>">
                                                                                 ...
                                                                                 <div id="ct-image-upload-popuppcaol<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" class="ct-image-upload-popup modal fade" tabindex="-1" role="dialog">
                                                                                    <div class="vertical-alignment-helper">
                                                                                       <div class="modal-dialog modal-md vertical-align-center">
                                                                                          <div class="modal-content">
                                                                                             <div class="modal-header">
                                                                                                <div class="col-md-12 col-xs-12">                                                                <a data-us="pcaol<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" class="btn btn-success ct_upload_img2" data-imageinputid="ct-upload-imagepcaol<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" data-id="<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" ><?php echo $label_language_values['crop_and_save']; ?></a>                                                                <button type="button" class="btn btn-default hidemodal" data-dismiss="modal" aria-hidden="true"><?php echo $label_language_values['cancel']; ?></button>                                                            </div>
                                                                                             </div>
                                                                                             <div class="modal-body">                                                            <img id="ct-preview-imgpcaol<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" />                                                        </div>
                                                                                             <div class="modal-footer">
                                                                                                <div class="col-md-12 np">
                                                                                                   <div class="col-md-4 col-xs-12">                                                                    <label class="pull-left"><?php echo $label_language_values['file_size']; ?></label> <input type="text" class="form-control" id="pcaolfilesize<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" name="filesize" />                                                                </div>
                                                                                                   <div class="col-md-4 col-xs-12">                                                                    <label class="pull-left">H</label> <input type="text" class="form-control" id="pcaol<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>h" name="h" />                                                                </div>
                                                                                                   <div class="col-md-4 col-xs-12">                                                                    <label class="pull-left">W</label> <input type="text" class="form-control" id="pcaol<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>w" name="w" />                                                                </div>
                                                                                                   <!-- hidden crop params -->                                                                <input type="hidden" id="pcaol<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>x1" name="x1" />                                                                <input type="hidden" id="pcaol<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>y1" name="y1" />                                                                <input type="hidden" id="pcaol<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>x2" name="x2" />                                                                <input type="hidden" id="pcaol<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>y2" name="y2" />                                                                <input type="hidden" id="pcaol<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>id" name="id" value="<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" />                                                                <input id="pcaolctimage<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" type="hidden" name="ctimage" />                                                                <input type="hidden" id="lastrecordid" value="addon_<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>">                                                                <input type="hidden" id="pcaol<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>ctimagename" class="pcaolimg" name="ctimagename" value="<?php echo $arrs['image']; ?>" />                                                                <input type="hidden" id="pcaol<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>newname" value="addon_" />
                                                                                                </div>
                                                                                             </div>
                                                                                          </div>
                                                                                       </div>
                                                                           ...
                                                                           <tr>
                                                                              ...
                                                                              <td>
                                                                                 <div class="col-xs-12 np">
                                                                                    <div class="input-group">                                                <span class="input-group-addon"><?php echo $settings->get_option('ct_currency_symbol'); ?></span>                                                <input type="text" id="myedtaddon_baseprice<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" name = "myedtaddon_baseprice<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" class="form-control txtedtaddon_baseprice<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" placeholder="US Dollar" value="<?php if (isset($arrs['base_price'])) {echo $arrs['base_price'];} else {}?>">                                            </div>
                                                                                    <label for="myedtaddon_baseprice<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" generated="true" class="error"></label>
                                                                                 </div>
                                                                              </td>
                                                                           </tr>
                                                                           <tr>
                                                                              ...
                                                                              <td>
                                                                                 <div class="col-xs-12 np">                               <input type="text" class="form-control txtedtaddon_maxqty<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" id="myedtaddon_maxqty<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" name = "myedtaddon_maxqty<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" value="<?php echo $arrs['maxqty']; ?>"/>                                        </div>
                                                                              </td>
                                                                           </tr>
                                                                           <tr>
                                                                              <td><label for="phone-number"><?php echo $label_language_values['multiple_qty']; ?></label></td>
                                                                              <td>                                        <label for="addon-multi-qty<?php echo $i; ?>">                                 <input class='txtedtaddon_multipleqty' data-toggle="toggle" data-size="small" type='checkbox' data-id="<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" <?php if ($arrs['multipleqty'] == 'Y') {
                                                            echo "checked";
                                                         } else {
                                                            echo "";
                                                                           ...
                                                                           <tr>
                                                                              <td></td>
                                                                              <td><a data-id="<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" class="btn btn-success ct-btn-width  btneditaddon_service com_set"><?php echo $label_language_values['update']; ?>           </a>
                                                               ...
                                                               <div class="ct-service-collapse-div col-sm-12 col-md-6 col-lg-6 col-xs-12 manage-addon-price-container<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" style="display:<?php if ($settings->get_option('ct_calculation_policy') == "M") {
                                                            echo "none";
                                                         } else {
                                                            echo "block";
                                                         }?>">
                                                                     ...
                                                                     <div class="manage-unit-price-main col-sm-12 col-md-12 col-lg-12 col-xs-12">
                                                                        ...
                                                                        <ul>
                                                                           <li class="form-group">
                                                                              ...
                                                                              <div class="col-xs-12 col-sm-3">                                                <input class="pull-left form-control" readonly value="<?php if (isset($arrs['base_price'])) {echo $arrs['base_price'];} else {}?>" placeholder="<?php echo $label_language_values['price']; ?>" type="text" />                                            </div>
                                                                           </li>
                                                                        </ul>
                                                                        <ul class="myaddonspricebyqty<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>">
                                                                           <?php $objservice_addon_rate->addon_service_id = $arrs['id'];
                                                         $idss = $arrs['id'];
                                                         $result = $objservice_addon_rate->readall();
                                                         if ($result->num_rows > 0) {
                                                            while ($r = mysqli_fetch_array($result)) {?>
                                                                              <li class="form-group myaddon-qty_price_row<?php if (isset($r['id'])) {echo $r['id'];} else {}?>">
                                                                                 <form id="myedtform_addonunits<?php if (isset($r['id'])) {echo $r['id'];} else {}?>">
                                                                                    <label class="col-sm-2 col-xs-12" for="addon_qty_6"><?php echo $label_language_values['Quantity']; ?></label>
                                                                                    <div class="col-xs-12 col-sm-2">                                             <input id="myedtqty_addon<?php if (isset($r['id'])) {echo $r['id'];} else {}?>" name="txtedtqtyaddons_<?php if (isset($r['id'])) {echo $r['id'];} else {}?>" class="form-control myloadedqty_addons<?php if (isset($r['id'])) {echo $r['id'];} else {}?>" placeholder="1" value="<?php echo $r['unit']; ?>" type="text"/>                                                    </div>
                                                                                    <div class="price-rules-select">
                                                                                       <select class="form-control myloadedrules_addons<?php if (isset($r['id'])) {echo $r['id'];} else {}?>">
                                       ...
                                       <div class="col-xs-12 col-sm-3">                                                        <input name="myedtpriceaddon" id="myedtprice_addon<?php if (isset($r['id'])) {echo $r['id'];} else {}?>" class="pull-left form-control myloadedprice_addons<?php if (isset($r['id'])) {echo $r['id'];} else {}?>" value="<?php echo $r['rate']; ?>" placeholder="<?php echo $label_language_values['price']; ?>" type="text"/>                                                    </div>
                                       <a data-id="<?php if (isset($r['id'])) {echo $r['id'];} else {}?>"                                                       class="btn btn-circle btn-success  pull-left update-addon-rule myloadedbtnsave_addons"><i class="fa fa-thumbs-up"></i></a>                                                    <a href="javascript:void(0);" data-id="<?php if (isset($r['id'])) {echo $r['id'];} else {}?>"                                                       class="btn btn-circle btn-danger pull-left delete-addon-rule myloadedbtndelete_addons"><i class="fa fa-trash"></i></a>
                                    </form>
                                 </li>
                                                                                 <?php
                                                   }
                                 ...
                                 <li class="form-group">
                                    <form id="mynewaddedform_addonunits<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>">
                                       <label class="col-sm-2 col-xs-12" for="addon_qty_6"><?php echo $label_language_values['Quantity']; ?></label>
                                       <div class="col-xs-12 col-sm-2">                                                    <input name="mynewssqtyaddon<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>"                                                           id="mynewaddedqty_addon<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>"                                                           class="form-control mynewqty_addons<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>"                                                           placeholder="1"                                                           value="" type="text"/>                                                </div>
                                       <div class="price-rules-select">
                                          <select                                                        class="form-control mynewrules_addons<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>">
                                             <option selected value="E">=</option>
                                             <option value="G"> &gt; </option>
                                          </select>
                                       </div>
                                       <div class="col-xs-12 col-sm-3">                                                    <input name="mynewsspriceaddon<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>"                                                           id="mynewaddedprice_addon<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>"                                                           class="pull-left form-control mynewprice_addons<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>"                                                           value=""                                                           placeholder="<?php echo $label_language_values['price']; ?>" type="text"/>                                                </div>
                                       <a href="javascript:void(0);" data-id="<?php if (isset($arrs['id'])) {echo $arrs['id'];} else {}?>" data-inspector="0" class="btn btn-circle btn-success add-addon-price-rule form-group new-manage-price-list mybtnaddnewqty_addon"><?php echo $label_language_values['add_new']; ?></a>
                                    </form>
                                 </li>
                                                </ul>
                                             </div>
                                                                                    ...
                                                                                    <div class="modal-content">
                                                                                       ...
                                                                                       <div class="modal-footer">
                                                                                          <div class="col-md-12 np">
                                                                                             ...
                                                                                             <?php
                                                                                                      $asd = $objservice_addon->getlast_record_insert();

                                                                                                         ?>
                                                                                             <input type="hidden" id="pcaoid" name="id" value="<?php echo ((int) $asd[0] + 1); ?>" />                                                                <input id="pcaoctimage" type="hidden" name="ctimage" />                                                                <input type="hidden" id="lastrecordid" value="addon_<?php echo ((int) $asd[0] + 1); ?>">                                                                <input type="hidden" id="pcaoctimagename" class="pcaoimg" name="ctimagename" value="" />                                                                <input type="hidden" id="pcaonewname" value="addon_" />
                                                                                          </div>
                                                                                       </div>
                                                                                    </div>
                                                                                 </div>
...
<?php /* echo mysqli_num_rows($res); */
    ...
    if ($addons_rates->num_rows > 0) {
        while ($addons_rates_arr = mysqli_fetch_array($addons_rates)) { /* DELETE ADDONS RATE*/
