  ...
  if ($maxx_limitts->num_rows > 0) {
    while ($maxx_limitt = mysqli_fetch_array($maxx_limitts)) {
      ...
      <div class="ct-list-header">
        <h3 class="header3"><?php if (isset($maxx_limitt['units_title'])) {
          echo $maxx_limitt['units_title'];
        } else {
        } ?></h3>
      </div>
      <div class="ct-address-area-main">
        <div class="ct-area-type">
          <span
            class="area-header"><?php if (isset($maxx_limitt['limit_title']) != "") {
              echo $maxx_limitt['limit_title'];
            } else {
              echo ucwords($maxx_limitt['units_title']);
            } ?></span>
          <?php
          if (isset($_SESSION['ct_cart']['method']) && count($_SESSION['ct_cart']['method']) > 0) {
            foreach ($_SESSION['ct_cart']['method'] as $method) {
              ...
              if ($method['method_id'] == $_POST['method_id'] && $method['service_id'] == $_POST['service_id'] && $method['units_id'] == $maxx_limitt['id']) {
                $flag = 1;
                ?>
                <input maxlength="5" value="<?php echo $method['s_m_qty']; ?>" type="text"
                  class="ct-area-input ct_area_m_units_rattee ct_area_m_units"
                  id="ct_area_m_units<?php if (isset($maxx_limitt['id'])) {
                    echo $maxx_limitt['id'];
                  } else {
                  } ?>"
                  data-service_id="<?php echo $_POST['service_id']; ?>"
                  data-units_id="<?php if (isset($maxx_limitt['id'])) {
                    echo $maxx_limitt['id'];
                  } else {
                  } ?>"
                  data-method_id="<?php echo $_POST['method_id']; ?>" data-rate=""
                  data-method_name="<?php if (isset($maxx_limitt['units_title'])) {
                    echo $maxx_limitt['units_title'];
                  } else {
                  } ?>"
                  data-maxx_limit="<?php if (isset($maxx_limitt['maxlimit'])) {
                    echo $maxx_limitt['maxlimit'];
                  } else {
                  } ?>"
                  data-minn_limit="<?php if (isset($maxx_limitt['minlimit'])) {
                    echo $maxx_limitt['minlimit'];
                  } else {
                  } ?>"
                  data-type="<?php echo "method_units"; ?>" data-mnamee="<?php echo $mmnameee; ?>" />
                <?php
                break;
              }
            }
            if ($flag == 0) {
              ?>
              <input maxlength="5" type="text" class="ct-area-input ct_area_m_units_rattee ct_area_m_units"
                id="ct_area_m_units<?php if (isset($maxx_limitt['id'])) {
                  echo $maxx_limitt['id'];
                } else {
                } ?>"
      ...
      <span
        class="error_of_max_limitss<?php if (isset($maxx_limitt['id'])) {
          echo $maxx_limitt['id'];
        } else {
        } ?> error"></span>
      <span
        class="error_of_min_limitss<?php if (isset($maxx_limitt['id'])) {
          echo $maxx_limitt['id'];
        } else {
        } ?> error"></span>
      <span
        class="error_of_invalid_area<?php if (isset($maxx_limitt['id'])) {
          echo $maxx_limitt['id'];
        } else {
        } ?> error"></span>
      <?php
...
<?php
  ...
  echo json_encode($u_msg);
  die();
}

/* get methods in dropdown on click of service */ elseif (isset($_POST['operationgetmethods'])) {
...
/* get add-on on click of service */ elseif (isset($_POST['get_service_addons'])) {
  ...
  if (mysqli_num_rows($addons_data) > 0) {
    ...
    <div class="ct-list-header">
      ...
      <?php if ($settings->get_option("ct_front_tool_tips_status") == 'on' && $settings->get_option("ct_front_tool_tips_addons_services") != '') { ?>
        <a class="ct-tooltip-addon" href="#" data-toggle="tooltip"
          title="<?php echo $settings->get_option("ct_front_tool_tips_addons_services"); ?>."><i
          ...
          while ($adonsdata = mysqli_fetch_array($addons_data)) {
            ...
            if ($adonsdata['multipleqty'] == 'N') {
              ...
              <li class="ct-sm-6 ct-md-4 ct-lg-3 ct-xs-12 mb-15">
                ...
                if (sizeof($_SESSION['ct_cart']['method']) > 0) {
                  foreach ($_SESSION['ct_cart']['method'] as $addon) {
                    if ($addon['units_id'] == $adonsdata['id'] && $addon['method_id'] == '0' && $adonsdata['service_id'] == $addon['service_id']) {
                      ?>
                      <input type="checkbox" name="addon-checkbox" class="addon-checkbox add_addon_in_cart_for_multipleqty"
                        data-status="1" data-duration_value="-1" data-id="<?php echo $adonsdata['id']; ?>"
                        id="ct-addon-<?php echo $adonsdata['id']; ?>" data-rate="<?php echo $adonsdata['base_price']; ?>"
                        data-service_id="<?php echo $adonsdata['service_id']; ?>" data-method_id="0"
                        data-method_name="<?php echo $adonsdata['addon_service_name']; ?>" data-units_id="<?php echo $adonsdata['id']; ?>"
                        data-type="<?php echo "addon"; ?>" data-mnamee="<?php echo $mmnameee; ?>" checked />
                      <?php
                      break;
                    } else {
                      ?>
                      <input type="checkbox" name="addon-checkbox" class="addon-checkbox add_addon_in_cart_for_multipleqty"
                        data-status="2" data-duration_value="-1" data-id="<?php echo $adonsdata['id']; ?>"
                        id="ct-addon-<?php echo $adonsdata['id']; ?>" data-rate="<?php echo $adonsdata['base_price']; ?>"
                        data-service_id="<?php echo $adonsdata['service_id']; ?>" data-method_id="0"
                        data-method_name="<?php echo $adonsdata['addon_service_name']; ?>" data-units_id="<?php echo $adonsdata['id']; ?>"
                        data-type="<?php echo "addon"; ?>" data-mnamee="<?php echo $mmnameee; ?>" />
                      <?php
                    }
                  }
                } else {
                ...
                <label class="ct-addon-ser border-c ct_addon_ser<?php echo $adonsdata['id']; ?>"
                  for="ct-addon-<?php echo $adonsdata['id']; ?>"><span></span>
                  <div class="addon-price">
                    <?php echo $general->ct_price_format($adonsdata['base_price'], $symbol_position, $decimal); ?></div>
            ...
            <?php
              ...
              <li class="ct-sm-6 ct-md-4 ct-lg-3 ct-xs-12 mb-15 add_addon_class_selected"
                title='<?php echo $adonsdata['addon_service_description']; ?>'
                class="ct-sm-6 ct-md-4 ct-lg-3 ct-xs-12 remove_service_class ct-tooltip-services-addons tooltipstered">
                <?php
                $mmnameee = 'ad_unit' . $adonsdata['id'];
                ...
                if (sizeof($_SESSION['ct_cart']['method']) > 0) {
                  foreach ($_SESSION['ct_cart']['method'] as $addon) {
                    ...
                    if ($addon['units_id'] == $adonsdata['id'] && $addon['method_id'] == '0' && $addon['service_id'] == $adonsdata['service_id']) {
                      $flag = 1;
                      ?>
                      <input type="checkbox" name="addon-checkbox" class="addon-checkbox addons_servicess_2"
                        data-id="<?php echo $adonsdata['id']; ?>" id="ct-addon-<?php echo $adonsdata['id']; ?>"
                        data-mnamee="<?php echo $mmnameee; ?>" checked />
                      <?php
                      break;
                    }
                  }
                    ...
                    if ($addon['units_id'] == $adonsdata['id'] && $addon['method_id'] == '0') {
                      ...
                      <div class="ct-addon-count border-c  add_minus_buttonn add_minus_buttonid<?php echo $adonsdata['id']; ?>">
                        ...
                        <div class="ct-btn-group">
                          <button data-ids="<?php echo $adonsdata['id']; ?>" id="minus<?php echo $adonsdata['id']; ?>"
                            class="minus ct-btn-left ct-small-btn" type="button" data-units_id="<?php echo $adonsdata['id']; ?>"
                            data-duration_value="" data-mnamee="<?php echo $mmnameee; ?>"
                            data-method_name="<?php echo $adonsdata['addon_service_name'] ?>"
                            data-service_id="<?php echo $_POST['service_id']; ?>" data-rate="" data-method_id="0"
                            data-type="<?php echo "addon"; ?>">-</button>

                          <input type="text" value="<?php echo $addon['s_m_qty']; ?>"
                            class="ct-btn-text addon_qty data_addon_qtyrate qtyyy_<?php echo $mmnameee; ?>"
                            data-rate="<?php echo $uniitt_rate; ?>" />

                          <button data-ids="<?php echo $adonsdata['id']; ?>" id="add<?php echo $adonsdata['id']; ?>"
                            data-db-qty="<?php echo $adonsdata["maxqty"]; ?>" data-mnamee="<?php echo $mmnameee; ?>"
                            class="add ct-btn-right float-right ct-small-btn" type="button"
                            data-units_id="<?php echo $adonsdata['id']; ?>" data-service_id="<?php echo $_POST['service_id']; ?>"
                            data-method_id="0" data-duration_value="" data-method_name="<?php echo $adonsdata['addon_service_name'] ?>"
                            data-rate="" data-type="<?php echo "addon"; ?>">+</button>
                        </div>
                      </div>
                      <?php
                      break;
                  ...
                  if ($flag == 0) {
                    ...
                    <div class="ct-addon-count border-c  add_minus_button add_minus_buttonid<?php echo $adonsdata['id']; ?>">
                      ...
                      <div class="ct-btn-group">
                        ...
                        <input type="text" value="-1" class="ct-btn-text addon_qty data_addon_qtyrate qtyyy_<?php echo $mmnameee; ?>"
                          data-rate="<?php echo $uniitt_rate; ?>" />
        ...
        if (mysqli_num_rows($addons_data) > 0) {
          while ($adonsdata = mysqli_fetch_array($addons_data)) {
            ...
            if ($adonsdata['multipleqty'] == 'N') {
              ...
              <li class="ct-sm-6 ct-md-4 ct-lg-3 ct-xs-12 mb-15">
                <input type="checkbox" name="addon-checkbox" class="addon-checkbox add_addon_in_cart_for_multipleqty"
                  data-status="2" data-duration_value="-1"
                  data-id="<?php if (isset($adonsdata['id'])) {
                    echo $adonsdata['id'];
                  } else {
                  } ?>"
                  id="ct-addon-<?php if (isset($adonsdata['id'])) {
                    echo $adonsdata['id'];
                  } else {
                  } ?>"
                  data-rate="<?php if (isset($adonsdata['base_price'])) {
                    echo $adonsdata['base_price'];
                  } else {
                  } ?>"
                  data-service_id="<?php if (isset($adonsdata['service_id'])) {
                    echo $adonsdata['service_id'];
                  } else {
                  } ?>"
                  data-method_id="0" data-method_name="<?php echo $adonsdata['addon_service_name']; ?>"
                  data-units_id="<?php if (isset($adonsdata['id'])) {
                    echo $adonsdata['id'];
                  } else {
                  } ?>"
                  data-type="<?php echo "addon"; ?>" data-mnamee="<?php echo $mmnameee; ?>" />
                <label
                  class="ct-addon-ser border-c ct_addon_ser<?php if (isset($adonsdata['id'])) {
                    echo $adonsdata['id'];
                  } else {
                  } ?>"
                  for="ct-addon-<?php if (isset($adonsdata['id'])) {
                    echo $adonsdata['id'];
                  } else {
                  } ?>"><span></span>
                  <div class="addon-price">
            ...
            <?php
              ...
              <li class="ct-sm-6 ct-md-4 ct-lg-3 ct-xs-12 mb-15 add_addon_class_selected">
                ...
                <input type="checkbox" name="addon-checkbox" class="addon-checkbox addons_servicess_2"
                  ...
                  data-mnamee="<?php echo $mmnameee; ?>" />
                <label class="ct-addon-ser border-c"
                  for="ct-addon-<?php if (isset($adonsdata['id'])) {
                    echo $adonsdata['id'];
                  } else {
                  } ?>"><span></span>
          ...
          for ($i = 1; $i <= $addon_dataaa["maxqty"]; $i++) {
            ...
            if ($fg == 1) {
              if ($unt_ratess['rules'] == 'E') {
                ?>
                <span class="ct-addon-box">
                  <a href="javascript:void(0);" class="br-3 ct-addon-btn add_item_in_cart"
                    data-rate="<?php echo ($calculation_policy == "M") ? $unt_ratess['rate'] * $i : $unt_ratess['rates']; ?>"
                    data-duration_value="<?php echo $i; ?>" data-units_id="<?php echo $addon_dataaa['id']; ?>"
                    data-service_id="<?php echo $addon_dataaa['service_id']; ?>" data-method_id="0"
                    data-method_name="<?php echo $addon_dataaa['addon_service_name']; ?>" data-type="<?php echo "addon"; ?>"
                    data-mnamee="<?php echo $mmnameee; ?>"><?php echo $i; ?></a>
                </span>
              <?php
              } else {
                ?>
              ...
              <span class="ct-addon-box">
                <a href="javascript:void(0);" class="br-3 ct-addon-btn add_item_in_cart"
                  data-rate="<?php echo ($calculation_policy == "M") ? $unt_ratess['rate'] * $i : $unt_ratess['rate']; ?>"
                  data-duration_value="<?php echo $i; ?>" data-units_id="<?php echo $addon_dataaa['id']; ?>"
                  data-service_id="<?php echo $addon_dataaa['service_id']; ?>" data-method_id="0"
                  data-method_name="<?php echo $addon_dataaa['addon_service_name']; ?>" data-type="<?php echo "addon"; ?>"
                  data-mnamee="<?php echo $mmnameee; ?>"><?php echo $i; ?></a>
            ...
            <?php
              ...
              ?>
              <span class="ct-addon-box">
                <a href="javascript:void(0);" class="br-3 ct-addon-btn add_item_in_cart" data-rate="<?php echo $base_rates; ?>"
                  data-duration_value="<?php echo $i; ?>" data-units_id="<?php echo $addon_dataaa['id']; ?>"
                  data-service_id="<?php echo $addon_dataaa['service_id']; ?>" data-method_id="0"
                  data-method_name="<?php echo $addon_dataaa['addon_service_name']; ?>" data-type="<?php echo "addon"; ?>"
                  data-mnamee="<?php echo $mmnameee; ?>"><?php echo $i; ?></a>
...
<?php
  ...
  $strate = 1;
  ?>
  <!-- <h5 class="header5"> <?php if (isset($unt_values_3['units_title']) != "") {
  ...
  <h5 class="header5">
    <?php if (isset($unt_values_3['limit_title']) != "") {
  ...
  for ($i = 1; $i <= $unt_values['maxlimit']; $i++) {
    ...
    if ($fg == 1) {
      if ($unt_ratess['rules'] == 'E') {
        ...
        <span class="duration-box">
          <a href="javascript:void(0);" class="br-3 ct-duration-btn add_item_in_cart"
            data-rate="<?php echo ($calculation_policy == "M") ? $unt_ratess['rates'] * $i : $unt_ratess['rates']; ?>"
            data-units_id="<?php echo $unt_values['id']; ?>" data-duration_value="<?php echo $i; ?>"
            data-service_id="<?php echo $_POST['service_id']; ?>" data-method_id="<?php echo $_POST['method_id']; ?>"
            data-method_name="<?php echo $unt_values['units_title'] ?>" data-type="<?php echo "method_units"; ?>"
            data-mnamee="<?php echo $mmnameee; ?>"><?php echo $i; ?></a>
        </span>
      <?php
    ...
    <?php
      ...
      ?>
      <span class="duration-box">
        <a href="javascript:void(0);" class="br-3 ct-duration-btn add_item_in_cart" data-rate="<?php echo $base_rates; ?>"
          data-units_id="<?php echo $unt_values['id']; ?>" data-duration_value="<?php echo $i; ?>"
          data-service_id="<?php echo $_POST['service_id']; ?>" data-method_id="<?php echo $_POST['method_id']; ?>"
          data-method_name="<?php echo $unt_values['units_title'] ?>" data-type="<?php echo "method_units"; ?>"
          data-mnamee="<?php echo $mmnameee; ?>"><?php echo $i; ?></a>
...
<?php
  ...
  if ($unt_valuess_2->num_rows > 0) {
    while ($unt_values_2 = mysqli_fetch_array($unt_valuess_2)) {
      ...
      <div class="ct-bedrooms ct-btn-group ct-md-6 ct-sm-6 mb-15 ">
        <label>
          <?php if (isset($unt_values_2['limit_title']) != "") {
            echo $unt_values_2['limit_title'];
          } else {
            if (isset($unt_values_2['units_title'])) {
              echo $unt_values_2['units_title'];
            } else {
            }
          } ?></label>
        <div class="common-selection-main">
          <div class="selected-is select-bedrooms" data-mnamee="<?php echo $mmnameee; ?>"
            data-un_title="<?php if (isset($unt_values_2['units_title'])) {
              echo $unt_values_2['units_title'];
            } else {
            } ?>"
            data-un_id="<?php if (isset($unt_values_2['id'])) {
              echo $unt_values_2['id'];
            } else {
            } ?>"
            title="<?php echo $label_language_values['choose_your'] . " " . $unt_values_2['units_title']; ?>">

            <div class="data-list common-fc-2"
              id="ct_selected_<?php if (isset($unt_values_2['id'])) {
                echo $unt_values_2['id'];
              } else {
              } ?>">
          ...
          <div
            class="common-data-dropdown ct-<?php if (isset($unt_values_2['id'])) {
              echo $unt_values_2['id'];
            } else {
            } ?>-dropdown">
            <?php
            ...
            for ($i = $hfsec; $i <= $unt_values_2['maxlimit']; $i += $hfsec) {
              ...
              if ($fg == 1) {
                if ($unt_ratess['rules'] == 'E') {
                  ?>
                  <div class="data-list select_bedroom add_item_in_cart" data-duration_value="<?php echo $i; ?>"
                    data-units_id="<?php if (isset($unt_values_2['id'])) {
                      echo $unt_values_2['id'];
                    } else {
                    } ?>"
                    data-service_id="<?php echo $_POST['service_id']; ?>" data-method_id="<?php echo $_POST['method_id']; ?>"
                    data-method_name="<?php if (isset($unt_values_2['units_title'])) {
                      echo $unt_values_2['units_title'];
                    } else {
                    } ?>"
                    data-un_title="<?php if (isset($unt_values_2['units_title'])) {
              ...
              <?php
                ...
                <div class="data-list select_bedroom add_item_in_cart" data-duration_value="<?php echo $i; ?>"
                  ...
                  data-rate="<?php echo $base_rates; ?>" data-type="<?php echo "method_units"; ?>"
                  data-mnamee="<?php echo $mmnameee; ?>">
                  <p class="ct-count"><?php echo $i . " " . $unt_values_2['unit_symbol']; ?></p>
                </div>
              <?php
  ...
  if($unt_valuess_3->num_rows > 0){
      while($unt_values_3 = mysqli_fetch_array($unt_valuess_3)){
          ...
          <!-- <h5 class="header5"> <?php  if(isset($unt_values_3['units_title']) != ""){echo $unt_values_3['units_title'];}else{if(isset($unt_values_3['units_title'])){ echo $unt_values_3['units_title']; }else{ }} ?></h5> -->
          <h5 class="header5"> <?php  if(isset($unt_values_3['limit_title']) != ""){echo $unt_values_3['limit_title'];}else{if(isset($unt_values_3['units_title'])){ echo $unt_values_3['units_title']; }else{ }} ?></h5>
                      ...
                      if($fg == 1)
                      {
                          ...
                          ?>
                              ...
                              if (isset($_SESSION['ct_cart']['method']) && count($_SESSION['ct_cart']['method']) > 0) {
                                  ...
                                  $flag = 0;
                                      ...
                                      ?>
                                          <span class="ct-box bedroom-box">
                                              <a href="javascript:void(0);" class="br-3 ct-bedroom-btn select_m_u_btn u_<?php  if(isset($unt_values_3['id'])){ echo $unt_values_3['id']; }else{ } ?>_btn add_item_in_cart ct-bed-selected" data-units_id="<?php if(isset($unt_values_3['id'])){ echo $unt_values_3['id']; }else{ } ?>" data-duration_value="<?php echo $i; ?>" data-service_id="<?php echo $_POST['service_id']; ?>" data-method_id="<?php echo $_POST['method_id']; ?>" data-method_name="<?php if(isset($unt_values_3['units_title'])){ echo $unt_values_3['units_title']; }else{ }?>" data-un_title="<?php if(isset($unt_values_3['units_title'])){ echo $unt_values_3['units_title']; }else{ } ?>" data-rate="<?php echo ($calculation_policy == "M") ? $unt_ratess['rates']*$i : $unt_ratess['rates']; ?>" data-type="<?php echo "method_units"; ?>" data-mnamee="<?php echo $mmnameee; ?>"><?php echo $i." ". $unt_values_3['unit_symbol']; ?></a>
                                          </span>
                                      <?php
                                      break;
                                      }
                                  ...
                                  ?>
                                      <span class="ct-box bedroom-box">
                                          <a href="javascript:void(0);" class="br-3 ct-bedroom-btn select_m_u_btn u_<?php  if(isset($unt_values_3['id'])){ echo $unt_values_3['id']; }else{ } ?>_btn add_item_in_cart" data-units_id="<?php if(isset($unt_values_3['id'])){ echo $unt_values_3['id']; }else{ } ?>" data-duration_value="<?php echo $i; ?>" data-service_id="<?php echo $_POST['service_id']; ?>" data-method_id="<?php echo $_POST['method_id']; ?>" data-method_name="<?php if(isset($unt_values_3['units_title'])){ echo $unt_values_3['units_title']; }else{ }?>" data-un_title="<?php if(isset($unt_values_3['units_title'])){ echo $unt_values_3['units_title']; }else{ } ?>" data-rate="<?php echo ($calculation_policy == "M") ? $unt_ratess['rates']*$i : $unt_ratess['rates']; ?>" data-type="<?php echo "method_units"; ?>" data-mnamee="<?php echo $mmnameee; ?>"><?php echo $i." ". $unt_values_3['unit_symbol']; ?></a>
                                      </span>
                                  <?php
                                  }
                              }else{
                          ...
                          ?>
                              ...
                              if (isset($_SESSION['ct_cart']['method']) && count($_SESSION['ct_cart']['method']) > 0) {
                                  ...
                                  $flag = 0;
                                      ...
                                      ?>
                                          <span class="ct-box bedroom-box">
                                              <a href="javascript:void(0);" class="br-3 ct-bedroom-btn select_m_u_btn u_<?php  if(isset($unt_values_3['id'])){ echo $unt_values_3['id']; }else{ } ?>_btn add_item_in_cart ct-bed-selected" data-units_id="<?php if(isset($unt_values_3['id'])){ echo $unt_values_3['id']; }else{ } ?>" data-duration_value="<?php echo $i; ?>" data-service_id="<?php echo $_POST['service_id']; ?>" data-method_id="<?php echo $_POST['method_id']; ?>" data-method_name="<?php if(isset($unt_values_3['units_title'])){ echo $unt_values_3['units_title']; }else{ }?>" data-un_title="<?php if(isset($unt_values_3['units_title'])){ echo $unt_values_3['units_title']; }else{ } ?>" data-rate="<?php echo ($calculation_policy == "M") ? $strate*$i : $strate; ?>" data-type="<?php echo "method_units"; ?>" data-mnamee="<?php echo $mmnameee; ?>"><?php echo $i." ". $unt_values_3['unit_symbol']; ?></a>
                                          </span>
                                      <?php
                                      break;
                                      }
                      ...
                      else
                      {
                          ...
                          if (isset($_SESSION['ct_cart']['method']) && count($_SESSION['ct_cart']['method']) > 0) {
                              ...
                              $flag = 0;
                                  ...
                                  ?>
                                      <span class="ct-box bedroom-box">
                                          <a href="javascript:void(0);" class="br-3 ct-bedroom-btn select_m_u_btn u_<?php  if(isset($unt_values_3['id'])){ echo $unt_values_3['id']; }else{ } ?>_btn add_item_in_cart ct-bed-selected" data-units_id="<?php if(isset($unt_values_3['id'])){ echo $unt_values_3['id']; }else{ } ?>" data-duration_value="<?php echo $i; ?>" data-service_id="<?php echo $_POST['service_id']; ?>" data-method_id="<?php echo $_POST['method_id']; ?>" data-method_name="<?php if(isset($unt_values_3['units_title'])){ echo $unt_values_3['units_title']; }else{ }?>" data-un_title="<?php if(isset($unt_values_3['units_title'])){ echo $unt_values_3['units_title']; }else{ } ?>" data-rate="<?php echo $base_rates; ?>" data-type="<?php echo "method_units"; ?>" data-mnamee="<?php echo $mmnameee; ?>"><?php echo $i." ". $unt_values_3['unit_symbol']; ?></a>
                                      </span>
                                  <?php
                                  break;
                                  }
  ...
  if ($unt_values_4->num_rows > 0) {
    while ($u_value_4 = mysqli_fetch_array($unt_values_4)) {
      ...
      <div class="ct-bedrooms ct-btn-group ct-md-6 ct-sm-6">
        <label>
          <?php if ($u_value_4['limit_title'] != "") {
            echo $u_value_4['limit_title'];
          } else {
            echo $u_value_4['units_title'];
          } ?></label>
        <?php
        $mmnameee = 'mt_unit' . $u_value_4['id'];
        ?>
        <button id="minus-addon-<?php echo $u_value_4['id']; ?>" data-ids="<?php echo $u_value_4['id']; ?>"
          class="minuss ct-btn-left ct-small-btn" data-units_id="<?php echo $u_value_4['id']; ?>" data-duration_value=""
          data-method_name="<?php echo $u_value_4['units_title'] ?>" data-db-minqty="<?php echo $u_value_4["minlimit"]; ?>"
          data-hfsec="<?php echo $hfsec; ?>" type="button" data-service_id="<?php echo $_POST['service_id']; ?>" data-rate=""
          data-method_id="<?php echo $_POST['method_id']; ?>" data-type="<?php echo "method_units"; ?>"
          data-unit_symbol="<?php echo $u_value_4['unit_symbol']; ?>" data-mnamee="<?php echo $mmnameee; ?>">-</button>
        <input id="qty<?php echo $u_value_4['id']; ?>" type="text" value="0<?php echo " " . $u_value_4['unit_symbol']; ?>"
          class="qty<?php echo $u_value_4['id']; ?> ct-btn-text data_qtyrate" data-rate="<?php echo $uniitt_rate; ?>" />
        <button id="add-addon-<?php echo $u_value_4['id']; ?>" data-units_id="<?php echo $u_value_4['id']; ?>"
          data-ids="<?php echo $u_value_4['id']; ?>" data-db-qty="<?php echo $u_value_4["maxlimit"]; ?>"
          data-db-minqty="<?php echo $u_value_4["minlimit"]; ?>" data-hfsec="<?php echo $hfsec; ?>"
          data-service_id="<?php echo $_POST['service_id']; ?>" data-method_id="<?php echo $_POST['method_id']; ?>"
          class="addd ct-btn-right float-right ct-small-btn" data-duration_value=""
          data-method_name="<?php echo $u_value_4['units_title'] ?>"
          data-unit_symbol="<?php echo $u_value_4['unit_symbol']; ?>" data-rate="" type="button"
          data-type="<?php echo "method_units"; ?>" data-mnamee="<?php echo $mmnameee; ?>">+</button>
      </div>
    <?php
    }
  }
