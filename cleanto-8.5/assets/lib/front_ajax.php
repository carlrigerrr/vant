            ...
            ?>
                ...
                <div class="ct-address-area-main">
                    <div class="ct-area-type">
                        <span class="area-header"><?php if(isset($maxx_limitt['limit_title']) != ""){echo $maxx_limitt['limit_title'];}else{echo ucwords($maxx_limitt['units_title']);} ?></span>
                        <?php
                        if (isset($_SESSION['ct_cart']['method']) && count($_SESSION['ct_cart']['method']) > 0) {
                            ...
                            $flag = 0;
                                ...
                                $flag = 1;
                                ?>
                                    <input maxlength="5" value="<?php echo $method['s_m_qty']; ?>" type="text" class="ct-area-input ct_area_m_units_rattee ct_area_m_units" id="ct_area_m_units<?php if(isset($maxx_limitt['id'])){ echo $maxx_limitt['id']; }else{ } ?>" data-service_id="<?php echo $_POST['service_id']; ?>" data-units_id="<?php if(isset($maxx_limitt['id'])){ echo $maxx_limitt['id']; }else{ } ?>"  data-method_id="<?php echo $_POST['method_id']; ?>" data-rate="" data-method_name="<?php if(isset($maxx_limitt['units_title'])){ echo $maxx_limitt['units_title']; }else{ } ?>" data-maxx_limit="<?php if(isset($maxx_limitt['maxlimit'])){ echo $maxx_limitt['maxlimit']; }else{ } ?>" data-minn_limit="<?php if(isset($maxx_limitt['minlimit'])){ echo $maxx_limitt['minlimit']; }else{ } ?>" data-type="<?php echo "method_units"; ?>" data-mnamee="<?php echo $mmnameee; ?>"/>
                                <?php
                                break;
                                }
                            }
...
elseif(isset($_POST['operationgetmethods']))
{
	...
	unset($_SESSION['provider_sec']);
	$_SESSION['provider_sec'] = "";
    if($service_provider_list->num_rows > 0){
...
<h5 class="header5"> <?php  if(isset($unt_values['units_title']) != ""){echo $unt_values['units_title'];}else{if(isset($unt_values['units_title'])){ echo $unt_values['units_title']; }else{ }} ?></h5>   
        ...
        while($unt_values_2 = mysqli_fetch_array($unt_valuess_2)){
            ...
            <div class="ct-bedrooms ct-btn-group ct-md-6 ct-sm-6 mb-15">
                ...
                <?php   if($unt_values_2['units_title'] == "Bedroom(s)"){
                    ...
                    ?>
                    <img src="<?php  if($unt_values_2['image'] == '' && $unt_values_2['predefine_image'] == ''){
                                            echo SITE_URL.'assets/images/bed.png';
                                          }
                                          elseif($unt_values_2['image'] == '')
                                          {
                                            echo SITE_URL.'assets/images/unit-images/'.$unt_values_2['predefine_image'];
                                          }
                                          else
                                          {
                                            echo SITE_URL.'assets/images/services/'.$unt_values_2['image'];
                                          } ?> " class="set-bedroom">
                    <?php
                }
                else
                {
                    ...
                    ?>
                    <img src="<?php  if($unt_values_2['image'] == '' && $unt_values_2['predefine_image'] == ''){
                                            echo SITE_URL.'assets/images/bathroom.png';
                                          }
                                          elseif($unt_values_2['image'] == '')
                                          {
                                            echo SITE_URL.'assets/images/unit-images/'.$unt_values_2['predefine_image'];
                ...
                <div class="common-selection-main">
                    <div class="selected-is select-bedrooms" data-mnamee="<?php echo $mmnameee; ?>" data-un_title="<?php if(isset($unt_values_2['units_title'])){ echo $unt_values_2['units_title']; }else{ } ?>" data-un_id="<?php if(isset($unt_values_2['id'])){ echo $unt_values_2['id']; }else{ } ?>" title="<?php echo $label_language_values['choose_your']." ".$unt_values_2['units_title']; ?>">
                        <?php
                        if (isset($_SESSION['ct_cart']['method']) && count($_SESSION['ct_cart']['method']) > 0) {
                            foreach ($_SESSION['ct_cart']['method'] as $method) {
                            $flag = 0;
                                ...
                                $flag = 1;
                                ?>
                                    <div class="data-list common-fc-2" id="ct_selected_<?php  if(isset($unt_values_2['id'])){ echo $unt_values_2['id']; }else{ } ?>">
                    ...
                    <div class="common-data-dropdown ct-<?php if(isset($unt_values_2['id'])){ echo $unt_values_2['id']; }else{ } ?>-dropdown">
                        <?php 
                        $hfsec=0;
                        ...
                        for($i = $unt_values_2['minlimit']; $i <= $unt_values_2['maxlimit']; $i+=$hfsec) {
                            ...
                            if($fg == 1)
                            {
                                ...
                                {
                                    ?>
                                    <div class="data-list select_bedroom add_item_in_cart" data-duration_value="<?php echo $i; ?>" data-units_id="<?php if(isset($unt_values_2['id'])){ echo $unt_values_2['id']; }else{ } ?>" data-service_id="<?php echo $_POST['service_id']; ?>" data-method_id="<?php echo $_POST['method_id']; ?>" data-method_name="<?php if(isset($unt_values_2['units_title'])){ echo $unt_values_2['units_title']; }else{ }?>" data-un_title="<?php if(isset($unt_values_2['units_title'])){ echo $unt_values_2['units_title']; }else{ } ?>" data-rate="<?php echo ($calculation_policy == "M") ? $unt_ratess['rates']*$i : $unt_ratess['rates']; ?>" data-type="<?php echo "method_units"; ?>" data-mnamee="<?php echo $mmnameee; ?>">
                                    ...
                                    /* print the rate of the previous one */
                                    ?>
                                    <div class="data-list select_bedroom add_item_in_cart" data-duration_value="<?php echo $i; ?>" data-units_id="<?php if(isset($unt_values_2['id'])){ echo $unt_values_2['id']; }else{ } ?>" data-service_id="<?php echo $_POST['service_id']; ?>" data-method_id="<?php echo $_POST['method_id']; ?>" data-method_name="<?php if(isset($unt_values_2['units_title'])){ echo $unt_values_2['units_title']; }else{ }?>" data-un_title="<?php if(isset($unt_values_2['units_title'])){ echo $unt_values_2['units_title']; }else{ } ?>" data-rate="<?php echo ($calculation_policy == "M") ? $strate*$i : $strate; ?>" data-type="<?php echo "method_units"; ?>" data-mnamee="<?php echo $mmnameee; ?>">
                                        <p class="ct-count"><?php echo $i." ". $unt_values_2['unit_symbol']; ?></p>
                                    </div>
                                <?php 
                                }
                            ...
                            else
                            {
                                ...
                                ?>
                                <div class="data-list select_bedroom add_item_in_cart" data-duration_value="<?php echo $i; ?>" data-units_id="<?php if(isset($unt_values_2['id'])){ echo $unt_values_2['id']; }else{ } ?>" data-service_id="<?php echo $_POST['service_id']; ?>" data-method_id="<?php echo $_POST['method_id']; ?>" data-method_name="<?php if(isset($unt_values_2['units_title'])){ echo $unt_values_2['units_title']; }else{ }?>" data-un_title="<?php if(isset($unt_values_2['units_title'])){ echo $unt_values_2['units_title']; }else{ } ?>" data-rate="<?php echo $base_rates; ?>" data-type="<?php echo "method_units"; ?>" data-mnamee="<?php echo $mmnameee; ?>">
                                    <p class="ct-count"><?php echo $i." ". $unt_values_2['unit_symbol']; ?></p>
                                </div>
                            <?php 
                            }
                ...
                $flag = 0;
                    ...
                    ?>
                        <div class="ct-bedrooms ct-btn-group ct-md-6 ct-sm-6">
                            <label> <?php  if($u_value_4['limit_title'] != ""){echo $u_value_4['limit_title'];}else{if(isset($u_value_4['units_title'])){ echo $u_value_4['units_title']; }else{ };} ?></label>
                            <?php 
                            $mmnameee = 'mt_unit'.$u_value_4['id'];
                            ?>
                            <button id="minus-addon-<?php if(isset($u_value_4['id'])){ echo $u_value_4['id']; }else{ } ?>" data-ids="<?php if(isset($u_value_4['id'])){ echo $u_value_4['id']; }else{ } ?>" class="minuss ct-btn-left ct-small-btn" data-units_id="<?php if(isset($u_value_4['id'])){ echo $u_value_4['id']; }else{ } ?>" data-db-qty="<?php if(isset($u_value_4['maxlimit'])){ echo $u_value_4['maxlimit']; }else{ } ?>" data-db-minqty="<?php if(isset($u_value_4['minlimit'])){ echo $u_value_4['minlimit']; }else{ } ?>" data-duration_value="" data-method_name="<?php if(isset($u_value_4['units_title'])){ echo $u_value_4['units_title']; }else{ } ?>" data-hfsec="<?php echo $hfsec; ?>" type="button" data-service_id="<?php echo $_POST['service_id']; ?>" data-rate="" data-method_id="<?php echo $_POST['method_id']; ?>" data-type="<?php echo "method_units"; ?>" data-unit_symbol="<?php   if(isset($u_value_4['unit_symbol'])){ echo $u_value_4['unit_symbol']; }else{ } ?>" data-mnamee="<?php echo $mmnameee; ?>">-</button>
