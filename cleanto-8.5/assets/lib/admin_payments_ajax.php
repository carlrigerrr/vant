		...
		<tbody>
			...
			<tr>
				...
				<?php      
							...
							if(isset($rs['payment_method']) == "Stripe-payment")
							{	
							?>								
						...
						<td><?php if(isset($rs['transaction_id']) == ""){ echo "-";}
					...
					<td>
						<?php  if(isset($rs['discount']) == 0){ echo "Free"; }else{echo  $general->ct_price_format($rs['discount'],$symbol_position,$decimal);}?></td>
					<td>
						<?php  if(isset($rs['taxes']) == 0){ echo "Free"; }else{echo  $general->ct_price_format($rs['taxes'],$symbol_position,$decimal);}?></td>
					<td>
						<?php  if(isset($rs['net_amount']) == 0){ echo "Free"; }else{echo  $general->ct_price_format($rs['net_amount'],$symbol_position,$decimal);}?></td>
					<td>
						<?php  if(isset($rs['partial_amount']) == 0){ echo "Free"; }else{echo  $general->ct_price_format($rs['partial_amount'],$symbol_position,$decimal);}?></td>
					<?php 
                }
                else{
                    ?>
