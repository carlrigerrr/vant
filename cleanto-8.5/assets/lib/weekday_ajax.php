...
elseif(isset($_POST['add_offtime']))
{
    ...
    $abc = $obj_offtime->check_offtimes();
    if ($abc == 1) {
        echo "ok";
    }
    else
            ...
            <table class="form-horizontal" cellspacing="0">
                ...
                <tr>
                    <td>
                        ...
                        <button id="ct-close-popover-delete-breaks" class="btn btn-default close_popup" onclick="closePopover()"><?php echo $label_language_values['cancel'];?></button>
