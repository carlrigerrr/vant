...

{
     ...
     */
     ...
     private function _processResponse($response) {
        ...
        $errorMessage = isset($decoded->message) ? $decoded->message : '';
        $errorCode = isset($decoded->code) ? $decoded->code : null;
        $moreInfo = isset($decoded->more_info) ? $decoded->more_info : null;
    
        // Log error details for debugging
        error_log("Twilio API Error: Status: $status, Message: $errorMessage, Code: $errorCode, More Info: $moreInfo");
