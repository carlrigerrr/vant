...
class cleanto_dummy{
  ...
  public $services_method="ct_services_method";
	...
	public $smu_maxlimit;
	public $smu_status;
	public $smu_limit_title;
	public $smu_unit_symbol;
	public $smu_uduration;
  ...
  public $week_days_available="ct_week_days_available";
	...
	public $oci_order_duration;
	public $oci_reccuring_id;
	...
	public function add_services_method_unit(){
		$query="insert into `".$this->service_methods_units."` (`id`,`services_id`,`methods_id`,`units_title`,`base_price`,`minlimit`,`maxlimit`,`status`, `position`,`limit_title`,`unit_symbol`,`half_section`,`uduration`,`predefine_image`,`predefine_image_title`,`image`) values(NULL,'".$this->smu_service_id."','".$this->smu_methods_id."','".$this->smu_units_title."','".$this->smu_base_price."','".$this->smu_minlimit."','".$this->smu_maxlimit."','".$this->smu_status."', '0','".$this->smu_limit_title."','".$this->smu_unit_symbol."','D','".$this->smu_uduration."','".$this->sa_predefine_image."','".$this->sa_predefine_image_title."','".$this->sa_image."')";
		$result=mysqli_query($this->conn,$query);
		$value=mysqli_insert_id($this->conn);
		return $value;
	}
	...
	public function add_services_methods_units_rate(){
		$query="insert into `".$this->services_methods_units_rate."` (`id`,`units_id`,`units`,`rules`,`rates`,`urduration`) values(NULL,'".$this->smur_units_id."','".$this->smur_units."','".$this->smur_rules."','".$this->smur_rates."','".$this->smur_urduration."')";
		$result=mysqli_query($this->conn,$query);
		$value=mysqli_insert_id($this->conn);
		return $value;
	}
	...
	public function add_services_addon(){
		$query="insert into `".$this->services_addon."` (`id`,`service_id`,`addon_service_name`,`base_price`,`maxqty`,`image`,`multipleqty`,`status`,`position`,`predefine_image`,`predefine_image_title`,`aduration`) values(NULL,'".$this->sa_service_id."','".$this->sa_addon_service_name."','".$this->sa_base_price."','".$this->sa_maxqty."','".$this->sa_image."','".$this->sa_multipleqty."','".$this->sa_status."','0','".$this->sa_predefine_image."','".$this->sa_predefine_image_title."','".$this->sa_aduration."')";
		$result=mysqli_query($this->conn,$query);
		$value=mysqli_insert_id($this->conn);
		return $value;
	}
	...
	public function add_addon_service_rate(){
		$query="insert into `".$this->addon_service_rate."` (`id`,`addon_service_id`,`unit`,`rules`,`rate`,`arduration`) values(NULL,'".$this->asr_addon_service_id."','".$this->asr_unit."','".$this->asr_rules."','".$this->asr_rate."','".$this->asr_arduration."')";
		$result=mysqli_query($this->conn,$query);
		$value=mysqli_insert_id($this->conn);
		return $value;
	}
	...
	public function add_users(){
		 $query="insert into `".$this->users."` (`id`,`user_email`,`user_pwd`,`first_name`,`last_name`,`phone`,`zip`,`address`,`city`,`state`,`notes`,`vc_status`,`p_status`,`contact_status`,`status`,`usertype`,`cus_dt`,`stripe_id`,`referal_code`,`wallet_amount`) values(NULL,'".$this->u_user_email."','".$this->u_user_pwd."','".$this->u_first_name."','".$this->u_last_name."','".$this->u_phone."','".$this->u_zip."','".$this->u_address."','".$this->u_city."','".$this->u_state."','".$this->u_notes."','".$this->u_vc_status."','".$this->u_p_status."','".$this->u_contact_status."','".$this->u_status."','".$this->u_usertype."','".$this->u_cus_dt."','".$this->u_stripe_id."','NULL','0')";
		$result=mysqli_query($this->conn,$query);	
		$value=mysqli_insert_id($this->conn);
		return $value;
	}
	...
	public function add_payments(){
		$query="insert into `".$this->payments."` (`id`,`order_id`,`payment_method`,`transaction_id`,`amount`,`discount`,`taxes`,`partial_amount`,`payment_date`,`net_amount`,`lastmodify`,`frequently_discount`,`frequently_discount_amount`,`recurrence_status`,`payment_status`,`tip`) values(NULL,'".$this->p_order_id."','".$this->p_payment_method."','".$this->p_transaction_id."','".$this->p_amount."','".$this->p_discount."','".$this->p_taxes."','".$this->p_partial_amount."','".$this->p_payment_date."','".$this->p_net_amount."','".$this->p_lastmodify."','".$this->p_frequently_discount."','".$this->p_frequently_discount_amount."','N','Pending','".$this->t_tip."')";
		$result=mysqli_query($this->conn,$query);
		$value=mysqli_insert_id($this->conn);
		return $value;
	}
	...
	public function add_order_client_info(){
		$query="insert into `".$this->order_client_info."` (`id`,`order_id`,`client_name`,`client_email`,`client_phone`,`client_personal_info`,`order_duration`,`recurring_id`) values(NULL,'".$this->oci_order_id."','".$this->oci_client_name."','".$this->oci_client_email."','".$this->oci_client_phone."','".$this->oci_client_personal_info."','".$this->oci_order_duration."','".$this->oci_reccuring_id."')";
		$result=mysqli_query($this->conn,$query);
		$value=mysqli_insert_id($this->conn);
		return $value;
	...
	public function add_settings(){
	 ...
	 public function get_all_bookings_byserviceid($id){
        $query="select DISTINCT `order_id`, `gc_event_id`, `gc_staff_event_id`, `staff_ids` from `".$this->bookings."` where `service_id` = '".$id."' ";
        $result=mysqli_query($this->conn,$query);
        return $result;
    }
