...
class cleanto_setting{
	...
	public $ct_google_api_key;
	public $ct_minimum_booking_price;
	public $ct_additional_slot_time;
	...
	public $eng;
	/*Xero*/
	public $ct_xero_status;
	public $ct_xero_client_ID;
	public $ct_xero_client_secret;
  public $ct_xero_company_name;
  public $ct_sms_textlocal_admin_phone;
  public $ct_company_title_display;
  public $ct_company_address1;
  public $ct_company_address2;
  public $ct_appointment_details_display;
  public $ct_star_show_on_front;
  public $ct_show_time_duration;
  public $ct_sms_twilio_send_sms_to_staff_status;
  public $ct_sms_plivo_send_sms_to_staff_status;
  public $ct_sms_nexmo_send_sms_to_staff_status;
  public $ct_sms_textlocal_send_sms_to_staff_status;
  public $ct_referral_status;
  public $ct_referral_type;
  public $ct_referral_value;
  public $ct_special_days_status;
  public $ct_special_days;
  public $ct_special_days_title;
  public $ct_special_days_value;
  public $ct_special_day_color;
  public $ct_refs_type;
  public $ct_refs_value;
  public $ct_special_type;
  public $ct_service_design;
  public $ct_show_referral_input_on_checkout;
  public $ct_sms_messagebird_status;
  public $ct_sms_messagebird_account_apikey;
  public $ct_sms_messagebird_send_sms_to_client_status;
  public $ct_sms_messagebird_send_sms_to_admin_status;
  public $ct_sms_messagebird_send_sms_to_staff_status;
  public $ct_sms_messagebird_admin_phone;
  public $ct_limit_booking_time_slot;
  public $ct_booking_time_slot_limit;
  public $ct_staff_registration;
  public $ct_staff_zipcode;
  public $coupon_value;
  public $coupon_date;
  public $coupon_type;
  public $special_text;
  public $ct_allow_user_tip;
	...
	public function set_option($option_name, $option_value){
		...
		}elseif($option_name == "ct_privacy_policy_link"){
			$this->option_value = mysqli_real_escape_string($this->conn, $option_value);
		}elseif($option_name == "ct_terms_condition_link"){
			$this->option_value = mysqli_real_escape_string($this->conn, $option_value);
		}else{
			$this->option_value = $option_value;
		}
	...
	public function set_access_token($option_value){
    $ct_qb_session_access_token = mysqli_real_escape_string($this->conn, $option_value);
    // var_dump($ct_qb_session_access_token);die;
    $query = "UPDATE ct_settings SET option_value='".$ct_qb_session_access_token."' WHERE option_name='ct_qb_session_access_token'";
    $result = mysqli_query($this->conn, $query);
    return $result;
  }
	...
	public function get_lang($exist_lang){
		
		$query = "select * from `" . $this->table_language . "` where `language`='" . $exist_lang . "'";
		$result = mysqli_query($this->conn, $query);
		$value = mysqli_num_rows($result);
		return $value;
  }
  public function get_lang_en($eng){
	  //echo $eng;
		$query = "select * from `" . $this->table_language . "` where `language`='" . $eng . "'";
		$result = mysqli_query($this->conn, $query);
		$value = mysqli_fetch_array($result);
		return $value;
  }
  public function enter_lang()
  {
	  //echo $eng;
		$query = "INSERT INTO `" . $this->table_language . "` (`label_data`, `language`,`admin_labels`,`error_labels`,`extra_labels`,`front_error_labels`,`language_status`,`app_labels`) VALUES ('".$this->label_data."', '".$this->language."', '".$this->admin_labels."', '".$this->error_labels."', '".$this->extra_labels."', '".$this->front_error_labels."', '".$this->language_status."', '".$this->app_labels."')";
		$result = mysqli_query($this->conn, $query);
		return $result;
  }
  ...
  {
	  //echo $eng;
		$query = "INSERT INTO `ct_special_offer` (`coupon_value`, `coupon_date`,`coupon_type`,`special_text`) VALUES ('".$this->coupon_value."', '".$this->coupon_date."', '".$this->coupon_type."', '".$this->special_text."')";
		$result = mysqli_query($this->conn, $query);
		return $result;
  }
