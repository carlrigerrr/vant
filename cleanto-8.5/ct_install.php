				...
				<div class="container">
					...
					<div class="cti-inner">
						...
						<div id="cleanto-installer">
							...
							<h4>Cleanto Installer<div class="pull-right">Version 8.5</div></h4>
							<img src="assets/images/cleanto-logo.png" height="100%" width="180">
								...
								<div class="text_changed">
									...
									<div id="cti-content" class="col-md-8 col-sm-8 col-lg-8">
										...
										<div class="cti-info">
											...
											<img src="assets/images/cleanto-logo.png" height="40%" width="40%">
										...
										<a href="javascript:void(0)" class="btn btn-success installer_t_c_submit float-right next-btn" id="first_next">Start Install <i class="fa fa-angle-double-right"></i></a>
						...
						<footer class="product_ticket_footer">
						   <p style="color: white;" class="product_ticketp">If you are unable to install then you can submit a ticket here
					       <a href="https://skymoonlabs.ticksy.com/" class="product_ticket" id="">[https://skymoonlabs.ticksy.com/]</a>
						   </p>
					    </footer>
