...
?>
	<style>
	#cta #cta-payments div.dt-buttons {
...
<div id="cta-payments" class="panel tab-content">
    <div class="panel panel-default">
        ...
        <div id="client-payments" class="tab-pane fade in active">
        	<h3><?php echo $label_language_values['client_payments_details']; ?></h3>
			<div id="accordion" class="panel-group">
                <form id="" name="" class="" method="post">
					...
					<div class="col-md-2 col-sm-2 col-xs-12 col-lg-2 pr-15">
						<br />
				...
				<table id="payments-details" class="display responsive nowrap table table-striped table-bordered" cellspacing="0" width="100%">
					...
					<tr>
						...
						<th><?php echo $label_language_values['tip'];?></th>
					...
					while($rs = mysqli_fetch_array($r)){
						?>
						<tr>
							<td><?php if(isset($rs['order_id'])){ echo $rs['order_id']; }else{ } ?></td>
							<td>
								<?php 
							...
							if($rs['net_amount']==0){
								...
								<td><?php if($rs['tip'] == 0){ echo "Free"; }else{echo  $general->ct_price_format($rs['tip'],$symbol_position,$decimal);}?></td>
							...
							<?php 
								...
								<td><?php echo  $rs['tip']==0?"-":$general->ct_price_format($rs['tip'],$symbol_position,$decimal);?></td>
								<td ><?php echo $rs['recurrence_status'];?></td>
								<td style="display: flex;justify-content: space-between;"><?php echo $rs['payment_status'];?>   <a class="btn btn-primary update_payment_status" href="javascript:void(0);" id="update_payment_status" data-status="<?php echo $rs['payment_status'];?>" data-order_id="<?php if(isset($rs['order_id'])){ echo $rs['order_id']; }else{ }  ?>"><?php  echo $label_language_values['update']; ?></a></td>
								<?php 
								...
								?>
								<td>
									<a class="btn btn-primary send_inovoice" href="javascript:void(0);" id="send_inovoice" data-link="<?php echo SITE_URL; ?>assets/lib/download_invoice_client.php?iid=<?php if(isset($rs['order_id'])){ echo $rs['order_id']; }else{ }  ?>" data-email="<?php echo $p_client_email; ?>" data-name="<?php echo $client_name; ?>">
									<i class="fa fa-envelope"></i>
									<?php  echo $label_language_values['Send_Invoice']; ?>
									</a>
								</td>
							<?php 
							}
				...
				<div id="accordion" class="panel-group">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						...
						<div class="col-md-2 col-sm-2 col-xs-12 col-lg-2">
							<br />
							<button type="button" class="btn btn-info mb-15 get_payment_staff_by_date" name=""><?php echo $label_language_values['submit'];?></button>
						</div>
					</div>	
					<div class="mb-5" id="hr"></div>
					<div class="col-md-12 col-sm-12 col-xs-12">
