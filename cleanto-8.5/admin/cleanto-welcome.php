               ...
               <div class="panel-body">
                  <div class="ct-changelog-menu col-md-3 col-sm-4 col-xs-12 col-lg-3 np">
                     <ul class="nav nav-tab nav-stacked">
                        <li class="active"><a href="#version8_5" data-toggle="pill">What's new in 8.5? </a></li>
                        <li><a href="#version8_4" data-toggle="pill">Version 8.4 </a></li>
                        <li><a href="#version8_3" data-toggle="pill">Version 8.3 </a></li>
						      <li><a href="#version8_2" data-toggle="pill">Version 8.2 </a></li>
                        <li><a href="#version8_1" data-toggle="pill">Version 8.1 </a></li>
                  ...
                  <div class="panel-body">
                     ...
                     <div class="changelog-details tab-pane active" id="version8_5">
                       <h4 class="nm">What's new in Version 8.5?</h4>
                       <ul class="cta-changelog-ul">
                        <li><span class="ct-fixed bg-success br-3 b-shadow">Improved</span>SMTP setting</li>
                        <li><span class="ct-fixed bg-danger br-3 b-shadow">Fixed</span>Minor functional bugs</li>
                       </ul>
                    </div> 
                     <div class="changelog-details tab-pane" id="version8_4">
                       <h4 class="nm">What's new in Version 8.4?</h4>
                       <ul class="cta-changelog-ul">
                        <li><span class="ct-fixed bg-success br-3 b-shadow">Improved</span>Tip managable from admin</li>
                        <li><span class="ct-improved bg-success br-3 b-shadow">Added</span>Add Images in Method</li>
                        <li><span class="ct-fixed bg-danger br-3 b-shadow">Fixed</span> Minor functional bugs </li>
                       </ul>
                     </div> 
                    <div class="changelog-details tab-pane" id="version8_3">
                       <h4 class="nm">What's new in Version 8.3?</h4>
                       <ul class="cta-changelog-ul">
                        <li><span class="ct-fixed bg-success br-3 b-shadow">Added</span>SMTP Relay Validation</li>
                        <li><span class="ct-improved bg-success br-3 b-shadow">Improved</span>Google Calendar</li>
                        <li><span class="ct-fixed bg-danger br-3 b-shadow">Fixed</span> Minor functional bugs </li>
                       </ul>
                     </div> 
					      <div class="changelog-details tab-pane" id="version8_2">
                       <h4 class="nm">What's new in Version 8.2?</h4>
                       <ul class="cta-changelog-ul">
                        <li><span class="ct-fixed bg-success br-3 b-shadow">Added</span>Edit Booking</li>
                        <li><span class="ct-fixed bg-success br-3 b-shadow">Added</span>Compatibility with PHP version 8.2</li>
                        <li><span class="ct-fixed bg-danger br-3 b-shadow">Fixed</span> Minor functional bugs </li>
                       </ul>
                     </div> 
                    <div class="changelog-details tab-pane" id="version8_1">
