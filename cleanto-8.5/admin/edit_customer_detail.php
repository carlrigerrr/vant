				...
				<form class="edit_new_user_add edit_ocean" id="edit_new_user_add">
      				<div class="row">
      					<div class="col-md-6 col-sm-6 col-sm-6 col-xs-12 mt-10">
							...
							<input type="email"   value="<?php if(isset($customer_detail['user_email'])){
								echo $customer_detail['user_email'];
							}else{
								echo "NA";
							} ?>"id="admin_cus_edit_email" name="admin_cus_edit_email" placeholder="Your valid email address" class="form-control">
						</div>
      					<div class="col-md-6 col-sm-6 col-sm-6 col-xs-12 mt-10">
      						<label class="control-label"><?php echo $label_language_values['preferred_password'];?></label>
      						<input type="password" readonly id="admin_cus_edit_pwd" value="<?php if(isset($customer_detail['user_pwd'])){
								echo $customer_detail['user_pwd'];
							}else{
								echo "NA";
							} ?>" name="admin_cus_edit_pwd" placeholder="" class="form-control">
      					</div>
      				</div>
      				<div class="row">
      					<div class="col-md-6 col-sm-6 col-sm-6 col-xs-12 mt-10">
      						<label class="control-label"><?php echo $label_language_values['first_name'];?></label>
      						<input type="text" value="<?php if(isset($customer_detail['first_name'])){
								echo $customer_detail['first_name'];
							}else{
								echo "NA";
							} ?>" id="admin_cus_edit_fstnm" name="admin_cus_edit_fstnm" placeholder="" class="form-control">
      					</div>
      					<div class="col-md-6 col-sm-6 col-sm-6 col-xs-12 mt-10">
      						<label class="control-label"><?php echo $label_language_values['last_name'];?></label>
      						<input type="text" value="<?php if(isset($customer_detail['last_name'])){
								echo $customer_detail['last_name'];
							}else{
								echo "NA";
							} ?>" id="admin_cus_edit_lstnm" name="admin_cus_edit_lstnm" placeholder="" class="form-control">
      					</div>
      				</div>
					<div class="row">
      					<div class="col-md-4 col-sm-4 col-sm-4 col-xs-12 mt-10">
      						<label class="control-label"><?php echo $label_language_values['phone'];?></label>
      						<input type="text" value="<?php if(isset($customer_detail['phone'])){
								echo $customer_detail['phone'];
							}else{
								echo "NA";
							} ?>" id="admin_cus_edit_phone" name="admin_cus_edit_phone" placeholder="" class="form-control">
      					</div>
      					<div class="col-md-4 col-sm-4 col-sm-4 col-xs-12 mt-10">
      						<label class="control-label"><?php echo $label_language_values['zip'];?></label>
      						<input type="text" value="<?php if(isset($customer_detail['zip'])){
								echo $customer_detail['zip'];
							}else{
								echo "NA";
							} ?>" id="admin_cus_edit_zip" name="admin_cus_edit_zip" placeholder="" class="form-control">
      					</div>
						<div class="col-md-4 col-sm-4 col-sm-4 col-xs-12 mt-10">
      						<label class="control-label"><?php echo $label_language_values['address'];?></label>
      						<input type="text" value="<?php if(isset($customer_detail['address'])){
								echo $customer_detail['address'];
							}else{
								echo "NA";
							} ?>" id="admin_cus_edit_add" name="admin_cus_edit_add" placeholder="" class="form-control">
      					</div>
      				</div>
					<div class="row">
      					<div class="col-md-4 col-sm-4 col-sm-4 col-xs-12 mt-10">
      						<label class="control-label"><?php echo $label_language_values['city'];?></label>
      						<input type="text" value="<?php if(isset($customer_detail['city'])){
								echo $customer_detail['city'];
							}else{
								echo "NA";
							} ?>" id="admin_cus_edit_city" name="admin_cus_edit_city" placeholder="" class="form-control">
      					</div>
      					<div class="col-md-4 col-sm-4 col-sm-4 col-xs-12 mt-10">
      						<label class="control-label"><?php echo $label_language_values['state'];?></label>
      						<input type="text" value="<?php if(isset($customer_detail['state'])){
								echo $customer_detail['state'];
							}else{
								echo "NA";
							} ?>" id="admin_cus_edit_state" name="admin_cus_edit_state" placeholder="" class="form-control">
      					</div>
						<div class="col-md-4 col-sm-4 col-sm-4 col-xs-12 mt-10">
      						<label class="control-label"><?php echo $label_language_values['notes'];?></label>
      						<input type="text" value="<?php if(isset($customer_detail['notes'])){
								echo $customer_detail['notes'];
							}else{
								echo "NA";
							} ?>" id="admin_cus_edit_notes" name="admin_cus_edit_notes" placeholder="" class="form-control">
      					</div>
      				</div>
												...
												if(mysqli_num_rows($staff_status_detail) > 0){
													while($row = mysqli_fetch_assoc($staff_status_detail)){
														...
														/* if ($result_staff_info !== null) {
                                                            $staff_name = $result_staff_info['fullname'];
                                                        } else {
                                                            $staff_name = "";
                                                        } */
														?>
