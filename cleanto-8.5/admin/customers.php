						  ...
						  <div class="modal-dialog">
							...
							<div class="modal-content">
							  ...
							  <form id="registered-client-table1" style="overflow:hidden;" method="post"> 
									<table class="form-horizontal col-xs-12" cellspacing="0">
										...
										<tr class="form-field form-required">
											...
											<td class=" col-xs-10 pull-left"><input type="text" class="form-control ct_email add_show_error_class show-error" id="ct_email" name="ct_email" required="required" placeholder="<?php echo $label_language_values['your_valid_email_address']; ?>" /></td>
										</tr>
										<tr class="form-field form-required">
											<td class="col-xs-4"><label for="ab-newstaff-fullname" class=""><?php echo $label_language_values['preferred_password'];?></label></td>
											<td class=" col-xs-10 pull-left"><input type="password" class="form-control ct_password" id="ct_password" name="ct_password" required="required" placeholder="<?php echo $label_language_values['password']; ?>" /></td>
										</tr>
										<tr class="form-field form-required">
											<td class="col-xs-4"><label for="ab-newstaff-fullname" class=""><?php echo $label_language_values['first_name'];?></label></td>
											<td class=" col-xs-10 pull-left"><input type="text" class="form-control ct_first_name" id="ct_first_name" name="ct_first_name" required="required"  placeholder="<?php echo $label_language_values['your_first_name']; ?>" /></td>
										</tr>
										<tr class="form-field form-required">
											<td class="col-xs-4"><label for="ab-newstaff-fullname" class=""><?php echo $label_language_values['last_name'];?></label></td>
											<td class=" col-xs-10 pull-left"><input type="text" class="form-control ct_last_name" id="ct_last_name" name="ct_last_name" required="required"  placeholder="<?php echo $label_language_values['your_last_name']; ?>" /></td>
										</tr>
										<tr class="form-field form-required">
											<td class="col-xs-4"><label for="ab-newstaff-fullname" class=""><?php echo $label_language_values['phone'];?></label></td>
											<td class="col-xs-10 pull-left"><input type="tel" class="form-control ct_phone" id="ct_phone" name="ct_phone" required="required" placeholder="Your Phone Number" /></td>
											
										</tr>
										<tr class="form-field form-required">
											<td class="col-xs-4"><label for="ab-newstaff-fullname" class=""><?php echo $label_language_values['street_address'];?></label></td>
											<td class=" col-xs-10 pull-left"><textarea name="ct_address" id="ct_address" class="form-control ct_address" rows="" col="10" placeholder="<?php echo $label_language_values['street_address_placeholder']; ?>"></textarea>
										</tr>
										<tr class="form-field form-required">
											<td class="col-xs-4"><label for="ab-newstaff-fullname" class=""><?php echo $label_language_values['zip_code'];?></label></td>
											<td class=" col-xs-10 pull-left"><input type="text" class="form-control ct_zip_code" id="ct_zip_code" name="ct_zip_code" required="required" placeholder="<?php echo $label_language_values['zip_code_placeholder']; ?>" /></td>
										</tr>
										<tr class="form-field form-required">
											<td class="col-xs-4"><label for="ab-newstaff-fullname" class=""><?php echo $label_language_values['city'];?></label></td>
											<td class=" col-xs-10 pull-left"><input type="text" class="form-control ct_city" id="ct_city" name="ct_city" required="required" placeholder="<?php echo $label_language_values['city_placeholder']; ?>" /></td>
										</tr>
										<tr class="form-field form-required">
											<td class="col-xs-4"><label for="ab-newstaff-fullname" class=""><?php echo $label_language_values['state'];?></label></td>
											<td class=" col-xs-10 pull-left"><input type="text" class="form-control ct_state" id="ct_state" name="ct_state" required="required" placeholder="<?php echo $label_language_values['state_placeholder']; ?>" /></td>
										</tr>
							  ...
							  <div class="modal-footer">
								...
								<button type="button" class="btn btn-success ct_register_customer_btn"><?php echo $label_language_values['create'];?></button>
							</div>
							</div>
						  </div>
						  </form>
									...
									while($r_data = mysqli_fetch_array($reg_user_data)){
										...
										?>
											<tr id="myregisted_<?php  echo $r_data['id'];?>">
												<td><?php if(isset($r_data['first_name']) != '' && isset($r_data['last_name']) != ''){echo $r_data['first_name'].' '.$r_data['last_name'];}elseif(isset($r_data['first_name']) != '' && isset($r_data['last_name']) == ''){echo $r_data['first_name'];}elseif(isset($r_data['first_name']) == '' && isset($r_data['last_name']) != ''){echo $r_data['last_name'];}elseif(isset($r_data['first_name']) == '' && isset($r_data['last_name']) == ''){echo 'N/A';} ?></td>
