...
if(isset($_POST["action"]) && $_POST["action"] == "reject_appointment") {
	...
	if (isset($_POST["api_key"]) && $_POST["api_key"] == $objsettings->get_option("ct_api_key")) {
		...
		send_staff_email_sms($id,"R",$objdashboard,$setting,$booking,$english_date_array,$selected_lang_label,$admin_email,$general);
